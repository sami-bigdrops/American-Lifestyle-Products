        ...
        <div className="flex flex-col gap-8 sm:gap-10 md:gap-12">
          <div className="flex flex-col gap-4">
            ...
            <p className="font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:text-[16px] sm:leading-[28px]">
              By accessing and using American Lifestyle Products&apos; website and services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:text-[16px] sm:leading-[28px]">
              American Lifestyle Products provides lifestyle products and services including but not limited to:
            </p>
            <ul className="ml-6 flex flex-col gap-2 font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:ml-8 sm:text-[16px] sm:leading-[28px]">
              <li className="list-disc">Home and kitchen essentials</li>
              <li className="list-disc">Personal care products</li>
              <li className="list-disc">Organization and storage solutions</li>
              <li className="list-disc">Wellness and comfort products</li>
              <li className="list-disc">Daily lifestyle essentials</li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:text-[16px] sm:leading-[28px]">
              For product orders and payments:
            </p>
            <ul className="ml-6 flex flex-col gap-2 font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:ml-8 sm:text-[16px] sm:leading-[28px]">
              ...
              <li className="list-disc">Payment must be received before order processing</li>
              <li className="list-disc">We reserve the right to cancel orders for any reason</li>
              <li className="list-disc">Shipping costs and delivery times vary by location</li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="ml-6 flex flex-col gap-2 font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:ml-8 sm:text-[16px] sm:leading-[28px]">
              <li className="list-disc">Returns must be made within 30 days of delivery</li>
              <li className="list-disc">Products must be in original condition with packaging</li>
              <li className="list-disc">Refunds will be processed to the original payment method</li>
              <li className="list-disc">Shipping costs for returns are the customer&apos;s responsibility unless the product is defective</li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:text-[16px] sm:leading-[28px]">
              The service and its original content, features, and functionality are and will remain the exclusive property of American Lifestyle Products and its licensors. The service is protected by copyright, trademark, and other laws.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:text-[16px] sm:leading-[28px]">
              American Lifestyle Products provides services &quot;as is&quot; without any warranty. We do not guarantee:
            </p>
            <ul className="ml-6 flex flex-col gap-2 font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:ml-8 sm:text-[16px] sm:leading-[28px]">
              <li className="list-disc">Product availability at all times</li>
              <li className="list-disc">Specific product performance or results</li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-body text-[15px] leading-[26px] text-(--color-black-grey) sm:text-[16px] sm:leading-[28px]">
              You agree to defend, indemnify, and hold harmless American Lifestyle Products and its employees, contractors, agents, officers, and directors from and against any and all claims, damages, obligations, losses, liabilities, costs, or debt, and expenses (including attorney&apos;s fees).
            </p>
          </div>
